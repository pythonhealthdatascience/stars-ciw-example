...
If you find a bug in any of the code please report via [Github issues](https://github.com/pythonhealthdatascience/ciw_shinyapp/issues).  Please provide the following:
...
The book will evolve over time. We would greatly welcome feedback, via [Github issues](https://github.com/pythonhealthdatascience/ciw_shinyapp/issues), on the book including requests for new new topics, chapters, or expanded sections.
